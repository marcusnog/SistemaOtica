...
<head>
    ...
    <title>CRUD ótica - Cadastro - Desconto</title>
    <!-- plugins:css -->
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="cad-grupo.php">
                            ...
                            <span class="menu-title">Cadastro de Grupos/Subgrupos</span>
                        </a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="col-md-6 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Formulário Cadastro Fornecedor</h4>
                                <p class="card-description"> Cadastro de Fornecedor</p>
                                <form class="forms-sample" action="../../../connections/connection-cadfornecedor.php" method="POST">
                                    <div class="form-group">
                                        <label for="exampleInputName1">Descrição do Fornecedor</label>
                                        <input type="text" class="form-control" id="descricao" placeholder="Descrição fornecedor" name="descricao">
                                    </div>
