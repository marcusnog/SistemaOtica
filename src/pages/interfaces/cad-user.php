            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="col-md-6 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Formulário Cadastro</h4>
                                <p class="card-description">Cadastro de Usuário</p>
                                <form class="forms-sample" action="../../../connections/connection-cadastrar.php" method="POST">
                                    <div class="form-group">
                                        <label for="exampleInputName1">Nome</label>
                                        <input type="text" class="form-control" id="exampleInputName1" placeholder="Nome" name="nome">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputName1">Usuário</label>
                                        <input type="text" class="form-control" id="exampleInputName1" placeholder="Usuário" name="usuario">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword4">Senha</label>
                                        <input type="password" class="form-control" id="exampleInputPassword4" placeholder="Senha" name="senha">
                                    </div>
                                    <div class="form-group">
                                        <label for="dropdown">Este usuário é:</label>
                                        <select class="form-control" id="usertype"  name="tipouser" placeholder="tipo de usuário" rows="2">
