...
<head>
    ...
    <title>CRUD Ótica - Cadastro - Grupo</title>
    <!-- plugins:css -->
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="col-md-6 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Formulário Cadastro Subgrupo</h4>
                                <p class="card-description">Cadastro de Subgrupo</p>
                                <form class="forms-sample" action="../../../connections/connection-cadsubgrupo.php" method="POST">
                                    <div class="form-group">
                                        <label for="exampleInputName1">Descrição do subgrupo</label>
                                        <input type="text" class="form-control" id="descricao" placeholder="Descrição do subgrupo" name="descricao">
                                    </div>
