            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="col-md-6 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Formulário Cadastro Grupo</h4>
                                <p class="card-description">Cadastro de Grupo</p>
                                <form class="forms-sample" action="../../../connections/connection-cadgrupo.php" method="POST">
                                    <div class="form-group">
                                        <label for="exampleInputName1">Descrição do grupo</label>
                                        <input type="text" class="form-control" id="descricao" placeholder="Descrição do grupo" name="descricao">
                                    </div>
